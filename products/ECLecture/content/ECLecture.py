...
ECLectureSchema = SuperSchema.copy() + Schema((
    ...
    StringField('courseLables',
        required = False,
        widget = StringWidget(
            label = "Einordnung",
            description = "Themengebiet (Schwerpunkt Hauptstudium) und Kürzel für Studiengang",
            label_msgid = 'label_course_lables',
            description_msgid = 'help_course_lables',
            i18n_domain = I18N_DOMAIN,
        ),
    ),

    StringField('courseModule',
        required = False,
        widget = StringWidget(
            label = "Module",
            description = "Kürzel für Module",
            label_msgid = 'label_course_lables',
            description_msgid = 'help_course_lables',
            i18n_domain = I18N_DOMAIN,
        ),
    ...
    StringField('courseNumber',
        required = False,
        widget = StringWidget(
            label = "Vorlesungsnr.",
            description = "Veranstaltungsnummer",
            label_msgid = 'label_course_number',
            description_msgid = 'help_course_number',
            i18n_domain = I18N_DOMAIN,
        ),
    ),

#    LinesField('instructorssurname',
#        required = True,
#        languageIndependent = True,
#        searchable = True,
#        widget = LinesWidget(
#            label = "Nachnamen",
#            description = "Nachnamen der Dozenten, ein Name pro Zeile",
#            label_msgid = 'label_instructorssurname',
#            description_msgid = 'help_instructorssurname',
#            i18n_domain = I18N_DOMAIN,
#        ),
#    ),
...
#    ),
    ...
    StringField('courseTime',
        required = False,
        widget = StringWidget(
            size= 60,
            label = "Zeit",
            description = "Angaben zu Zeit und Turnus der Veranstaltung.",
            label_msgid = 'label_course_time',
            description_msgid = 'help_course_time',
            i18n_domain = I18N_DOMAIN,
        ),
    ),
    ...
    StringField('hours',
        widget = StringWidget(
            required = False,
            label = "Stundenzahl",
            description = "Stundenzahl (1stdg, 2stdg etc.)",
            label_msgid = 'lable_hours',
            description_msgid = 'help_hours',
            i18n_domain = I18N_DOMAIN,
        ),
    ),
...
#    ),
    ...
    TextField('theme',
        ...
        widget = TextAreaWidget(
            label = "Thematik",
            description = "Beschreiben Sie kurz den Inhalt Ihrer Veranstaltung",
            label_msgid = 'label_theme',
            description_msgid = 'help_theme',
            i18n_domain = I18N_DOMAIN,
        ),
    ),
    ...
    TextField('aims',
        ...
        widget = TextAreaWidget(
            label = "Ziel",
            description = "Beschreiben Sie kurz das Ziel Ihrer Veranstaltung",
            label_msgid = 'label_aims',
            description_msgid = 'help_aims',
            i18n_domain = I18N_DOMAIN,
        ),
    ),
    ...
    TextField('method',
        ...
        widget = TextAreaWidget(
            label = "Methode",
            description = "Beschreiben Sie kurz die Methode Ihrer Veranstaltung",
            label_msgid = 'label_method',
            description_msgid = 'help_method',
            i18n_domain = I18N_DOMAIN,
        ),
    ),
    ...
    TextField('qualification',
        ...
        widget = TextAreaWidget(
            label = "Qualifikation",
            description = "Was sind die Voraussetzungen eines Scheines?",
            label_msgid = 'label_qualification',
            description_msgid = 'label_qualification',
            i18n_domain = I18N_DOMAIN,
        ),
    ),
    ...
    TextField('literature',
        ...
        widget = TextAreaWidget(
            label = "Literatur",
            description = "Geben Sie grundlegende Literatur Ihres Kurses an",
            label_msgid = 'label_literature',
            description_msgid = 'help_literature',
            i18n_domain = I18N_DOMAIN,
        ),
    ),

    TextField('notesLecturer',
        required = False,
        default_content_type = 'text/plain',
        default_output_type = 'text/x-html-safe',
        allowable_content_types = zconf.ATDocument.allowed_content_types,
        widget = TextAreaWidget(
            label = "Anmerkungen des/der Lehrenden",
            description = "Geben Sie hier weitere Informationen an, die inhaltlich in keines der vorhergehenden Felder passen.",
            label_msgid = 'label_notes_lecturer',
            description_msgid = 'help_notes_lecturer',
            i18n_domain = I18N_DOMAIN,
        ),
    ),
...
#            label_msgid = "label_electure_body_text",
#            description = "Geben Sie hier weitere Informationen an, die inhaltlich in keines der vorhergehenden Felder passen. Beginnen Sie unbedingt mit einem »Heading«!",
#            description_msgid = "help_lecture_body_text",
#            rows = 18,
#            i18n_domain = I18N_DOMAIN,
